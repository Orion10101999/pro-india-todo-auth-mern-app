        ...
        <div className='mt-5'>
            <div className='bg-white w-full max-w-md mx-2 rounded overflow-hidden p-4 mx-auto'>
                ...
                <form className='grid gap-4 mt-5' onSubmit={handleSubmit}>
                    ...
                    <button type='submit' className='bg-primary text-lg  py-1 px-4 rounded hover:bg-secondary rounded mt-2 font-bold text-white leading-relaxed tracking-relaxed'>
                        Register
                    </button>
                </form>
